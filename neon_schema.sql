...
CREATE TABLE IF NOT EXISTS recipes (
  ...
  rest_time_min INTEGER NOT NULL DEFAULT 0,
...
ALTER TABLE recipes ADD COLUMN IF NOT EXISTS prep_time_min INTEGER NOT NULL DEFAULT 0;
ALTER TABLE recipes ADD COLUMN IF NOT EXISTS rest_time_min INTEGER NOT NULL DEFAULT 0;
ALTER TABLE recipes ADD COLUMN IF NOT EXISTS cook_time_min INTEGER NOT NULL DEFAULT 0;
